...
for(market in 2008:2017)
{
  df_structured <- str_tsne_data_df %>% filter(market_ids==market)
  write.csv(df_structured,paste0("./input_validation_test/tsne_structured_",market,".csv"),row.names = FALSE)
  
  df_visual <- viz_tsne_data_df %>% filter(market_ids==market)
  write.csv(df_visual,paste0("./input_validation_test/tsne_visual_",market,".csv"),row.names = FALSE)

  df_combination <- mix_tsne_data_df %>% filter(market_ids==market)
  write.csv(df_combination,paste0("./input_validation_test/tsne_combination_",market,".csv"),row.names = FALSE)
}
...
plot_C <- function(str_tsne_data_df, viz_tsne_data_df, mix_tsne_data_df, segment_text, market) {
  ...
  # Return the plots
  # list(p)
  ggsave(paste0("./tsne_plot_files/model_plotC_tsne_",segment_text,"_",market,"_",char1,"_",char2,".pdf"), plot=p, dpi = 300, height = 9, width = 9, units = "in")
  # pdf(paste0("./tsne_plot_files/model_plotC_tsne_", segment_text, "_", market, "_", char1, "_", char2, ".pdf"), width = 9, height = 9)
  # print(p)
  # dev.off()
...
ggsave(paste0("./tsne_plot_files/model_plotD_tsne_",segment_text1,segment_text2,segment_text3,"-",market,"_",char1,"_",char2,".pdf"), plot=p, dpi = 300, height = 9, width = 9, units = "in")
# pdf(paste0("./tsne_plot_files/model_plotD_tsne_",segment_text1,segment_text2,segment_text3,"-",market,"_",char1,"_",char2,".pdf"), width = 9, height = 9)
# print(p)
# dev.off()
