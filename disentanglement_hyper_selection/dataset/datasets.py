...
class Cars(Dataset):
    ...
    def __init__(self, root=os.path.join(DIR, '../results/'), transforms_list=[transforms.ToPILImage(),transforms.Resize((128)),transforms.Grayscale(1),transforms.ToTensor()], logger=logging.getLogger(__name__), split="train",model_name="temp",sup_signal="make",**kwargs):
